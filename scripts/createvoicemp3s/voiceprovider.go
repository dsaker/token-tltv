...
type VoiceProvider interface {
	...
	GetVoices(ctx context.Context, outputDir string) ([]interfaces.Voice, map[string]string, error)

	// CreateSampleMP3 creates a sample MP3 for a given voice
	CreateSampleMP3(ctx context.Context, voice interfaces.Voice, langName string, outputDir string) error
}
